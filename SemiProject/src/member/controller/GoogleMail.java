...
public class GoogleMail {
	...
	public void sendmail(String recipient, String certificationCode) throws Exception {
        ...
        prop.put("mail.smtp.user", "testyh23@gmail.com");
        ...
        // 제목 설정
        String subject = "localhost:9090/SemiProject/home.up 회원님의 비밀번호를 찾기위한 인증코드 발송";
        msg.setSubject(subject);
        
        // 보내는 사람의 메일주소
        String sender = "testyh23@gmail.com";
